...
<div class="site-about">
	...
	<center>
    <button type="button" onClick="toggleVisibility('myself');return false;" style="margin-top: 20px;">About Me</button>
	...
	<p id="myself" style="font-size: 18px; color: black;margin-top: 20px;">
	...
	<p id="Hobbies" style="font-size: 18px; color: black;margin-top: 20px;">
	...
	<p id="Interest" style="font-size: 18px; color: black;margin-top: 20px;">
