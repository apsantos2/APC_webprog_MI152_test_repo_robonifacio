...
<h2><a href="<?php echo base_url();?>index.php" style="color: white;">go to ain Page</a></h2>
</div>
<div id="body">
	<div id="content">
		<table align="center">
		...
		<?php foreach ($user_list as $u_key){ ?>
			...
			<tr>
				...
				<td width="40" align="left" ><a href="#" onClick="show_confirm('edit',<?php echo $u_key->user_id;?>)"><img class="edit" /></a></td>

				<td width="40" align="left" ><a href="#" onClick="show_confirm('delete',<?php echo $u_key->user_id;?>)"><img class="delete" /></a></td>
